...
* **App Triggers:** глубокая диагностика реальных причин фоновой активности — фоновые сервисы, sticky-сервисы, wakelocks, будильники, JobScheduler, сетевые соединения, boot-ресиверы и ещё 8 факторов.
* **Аналитика и логи:**
...
ReAppzuku автоматически защищает критичные системные процессы — Google Play Services, System UI, текущую клавиатуру, текущий лаунчер, телефонию, Bluetooth, NFC и сам Shizuku. OEM-приложения производителей (Xiaomi Security Center, Samsung Device Care, OPPO Phone Manager и др.) также защищены по производителю. Риска bootloop нет.
